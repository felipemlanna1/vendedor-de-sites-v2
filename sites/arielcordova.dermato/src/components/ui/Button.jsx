...
export default function Button({ children, href, variant = 'primary', className = '', ...props }) {
  ...
  const variants = {
    primary: 'bg-[var(--color-secondary)] text-white px-8 py-3.5 hover:bg-[var(--color-primary-dark)]',
    ...
    accent: 'bg-[var(--color-accent)] text-[var(--color-text-primary)] px-8 py-3.5 hover:bg-[var(--color-primary)]  hover:text-white',
