...
export default function LanguageToggle({ className = '' }) {
  ...
  return (
    <button
      onClick={toggle}
      className={`relative flex items-center gap-1.5 text-base font-medium px-3 py-2 rounded-lg hover:bg-[var(--color-primary)]/[0.04] ${className}`}
    ...
    >
      ...
      <div className="w-10 h-5 bg-[var(--color-border-light)] rounded-full relative mx-1 cursor-pointer">
        <motion.div
